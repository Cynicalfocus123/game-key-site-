...
export default function SiteHeader() {
  ...
  const signInPopup = (e: React.MouseEvent) => { if (user || !window.matchMedia("(min-width: 768px)").matches) return; e.preventDefault(); openGate("signin"); };
