...
export function GoogleButton({ label, callbackPath = "/account", noDivider }: { label: string; callbackPath?: string; noDivider?: boolean }) {
...
// Same-site path only (no "//host", no backslashes).
export const safeNext = (n: string | null | undefined) => (n && n.startsWith("/") && !n.startsWith("//") && !n.includes("\\") ? n : null);
